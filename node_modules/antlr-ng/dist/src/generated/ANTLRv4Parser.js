  ...
  grammarSpec() {
    ...
    try {
      this.enterOuterAlt(localContext, 1);
      {
        ...
        while ((_la - 37 & ~31) === 0 && (1 << _la - 37 & 15) !== 0 || _la === 72) {
          {
            {
              this.state = 135;
  ...
  rules() {
    ...
    try {
      this.enterOuterAlt(localContext, 1);
      {
        ...
        this.errorHandler.sync(this);
        _la = this.tokenStream.LA(1);
        while (_la === 9 || _la === 13 || (_la - 41 & ~31) === 0 && (1 << _la - 41 & 113) !== 0) {
          {
            {
              this.state = 271;
              this.ruleSpec();
    ...
    try {
      this.enterOuterAlt(localContext, 1);
      {
        ...
        do {
          ...
          this.errorHandler.sync(this);
          _la = this.tokenStream.LA(1);
        } while ((_la - 41 & ~31) === 0 && (1 << _la - 41 & 113) !== 0);
      }
    } catch (re) {
      if (re instanceof antlr.RecognitionException) {
        this.errorHandler.reportError(this, re);
        ...
        case ANTLRv4Parser.NOT:
          this.enterOuterAlt(localContext, 1);
          {
            ...
            do {
              ...
              this.errorHandler.sync(this);
              _la = this.tokenStream.LA(1);
            } while ((_la & ~31) === 0 && (1 << _la & 10512) !== 0 || (_la - 58 & ~31) === 0 && (1 << _la - 58 & 73729) !== 0);
          }
          break;
        ...
        case ANTLRv4Parser.NOT:
          this.enterOuterAlt(localContext, 1);
          {
            ...
            do {
              ...
              this.errorHandler.sync(this);
              _la = this.tokenStream.LA(1);
            } while ((_la & ~31) === 0 && (1 << _la & 10768) !== 0 || (_la - 58 & ~31) === 0 && (1 << _la - 58 & 73729) !== 0);
          }
          break;
        case ANTLRv4Parser.SEMI:
        case ANTLRv4Parser.RPAREN:
