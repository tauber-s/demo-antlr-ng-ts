...
const _Action = class _Action extends (_a = RuleElement, _chunks_dec = [ModelElement], _a) {
  constructor(...args) {
    var __super = (...args) => {
      super(...args);
      __publicField(this, "chunks", __runInitializers(_init, 8, this, [])), __runInitializers(_init, 11, this);
      return this;
    };
    if (args.length === 1) {
      __super(args[0]);
    } else if (args.length === 2) {
      const [factory, ast] = args;
      __super(factory, ast);
...
__decorateElement(_init, 5, "chunks", _chunks_dec, _Action);
__decoratorMetadata(_init, _Action);
