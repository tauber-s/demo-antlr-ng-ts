...
var _failChunks_dec, _a, _init;
import { ModelElement } from "../../misc/ModelElement.js";
import { ActionAST } from "../../tool/ast/ActionAST.js";
import { ActionTranslator } from "../ActionTranslator.js";
import { Action } from "./Action.js";
const _SemPred = class _SemPred extends (_a = Action, _failChunks_dec = [ModelElement], _a) {
  constructor(factory, ast) {
    ...
    __publicField(this, "failChunks", __runInitializers(_init, 8, this)), __runInitializers(_init, 11, this);
    ...
    if (failNode instanceof ActionAST) {
      ...
      this.msg = gen.target.getTargetStringLiteralFromANTLRStringLiteral(
        gen,
        failNode.getText(),
        true,
        true
...
__decorateElement(_init, 5, "failChunks", _failChunks_dec, _SemPred);
__decoratorMetadata(_init, _SemPred);
__name(_SemPred, "SemPred");
let SemPred = _SemPred;
export {
  SemPred
};
