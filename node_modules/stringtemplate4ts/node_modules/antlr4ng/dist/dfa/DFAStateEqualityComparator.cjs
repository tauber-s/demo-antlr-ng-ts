...
// src/dfa/DFAStateEqualityComparator.ts
var DFAStateEqualityComparator_exports = {};
__export(DFAStateEqualityComparator_exports, {
  DFAStateEqualityComparator: () => DFAStateEqualityComparator
});
module.exports = __toCommonJS(DFAStateEqualityComparator_exports);
...
// src/dfa/DFAStateEqualityComparator.ts
var DFAStateEqualityComparator = class _DFAStateEqualityComparator {
  static {
    __name(this, "DFAStateEqualityComparator");
  }
  static instance = new _DFAStateEqualityComparator();
  hashCode(state) {
